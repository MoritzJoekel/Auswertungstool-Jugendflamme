...
Public Class Network
    ...
    Public Shared Function DownloadFromFTP()
        Try
            ...
            dts.Clear()
            My.Computer.FileSystem.DeleteFile(FrmMain.DataStream)
            ...
            My.Computer.Network.DownloadFile(serverAddress, FrmMain.DataStream, "moritzjoekel_jufla", "Ww5bTjPev6NHL4uZ")
            'My.Computer.FileSystem.RenameFile(FrmMain.HomeStream + "\JuFlaUpload.xml", "JuFla_Data.xml")
            'dts.ReadXml(FrmMain.DataStream)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Function
